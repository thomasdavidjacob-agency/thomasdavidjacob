...
const aiServices = [
  ...
  {
    title: 'Systems Integration & Live Dashboards',
    image: '/images/ai-systems/integration-dashboards.webp',
    description:
      'Your POS, CRM, booking, invoicing, and accounting tools connected through APIs so data flows between them automatically — plus one live dashboard showing leads, bookings, and revenue in real time.',
    icon: (
      <svg className="w-7 h-7 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {packages.map((pkg) => (
              ...
              >
                ...
                <div className="mb-8">
                  ...
                  <p className="text-xs text-zinc-500 uppercase tracking-widest font-bold mt-3">
                    {pkg.price === 'Custom' ? 'Scoped to your business' : 'Starting at'}
                  </p>
